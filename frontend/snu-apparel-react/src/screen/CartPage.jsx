        ...
        <>
            <tr className="bg-white border-b hover:bg-gray-50 w-full">
                ...
                <td className="px-6 py-4">
                    <BodyOne className="">{name}</BodyOne>
                </td>
                <td className="px-6 py-4">
                    <BodyOne className="">${price.toFixed(2)}</BodyOne>
                </td>
                <td className="px-6 py-4">
                ...
                <td className="px-6 py-4">
                    <BodyOne className="">${totalPrice.toFixed(2)}</BodyOne>
                </td>
                <td className="px-6 py-4">
                    <button
                    onClick={removeCartItems}
                    className="w-8 h-8 bg-primary-green rounded-full flex items-center justify-center text-white"
                    >
